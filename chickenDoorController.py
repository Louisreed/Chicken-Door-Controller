...
async def scheduled_open_door(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=update.effective_chat.id, text="🐔 Good Morning, Chickens! Time to rise and shine! 🌞 Door opened. 🐔")


async def scheduled_close_door(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=update.effective_chat.id, text="🐔 Goodnight, feathery friends! Dream of corn and worms! 🌙 Door closed. 🐔")
